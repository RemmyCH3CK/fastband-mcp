...
export function Login() {
  ...
  const { signInWithEmail, signInWithGoogle, signInWithApple, signInWithGithub, signUp } = useAuthStore()
        ...
        <div className="card-glow p-8 animate-in" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="space-y-3 mb-6">
            ...
            <button
              ...
              className={clsx(
                'w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl',
                'bg-black text-white font-medium border border-void-600',
                'hover:bg-void-900 transition-all duration-200',
                'hover:shadow-lg hover:-translate-y-0.5',
                'disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-none'
              )}
            >
