"""
Core tool base classes and definitions.

This module provides abstract base types for tool implementations.
Both Dev and Enterprise products inherit from these types.

Architecture Rules:
- No framework-specific imports (FastAPI, Flask)
- No database driver imports
- No environment file loading
- Protocol-agnostic: schema methods produce dicts, not protocol objects
"""
...
class ToolDefinition:
    ...
    Protocol-agnostic: provides schema methods that return plain dicts.
    ...
    def to_schema(self) -> dict[str, Any]:
        ...
        Returns a protocol-agnostic dict that can be adapted
        to MCP, OpenAI, or other formats.
        """
        properties = {}
        required = []
...
class ToolResult:
    ...
    def to_content(self) -> list[dict[str, Any]]:
        ...
        Returns protocol-agnostic content list.
        """
        if self.success:
